...
const configsModerator = {
    ...
    // this configsModerator's resolution value. Defaults to requesting an ideal
    // resolution of 720p.
    // constraints: {
    //     video: {
    //         height: {
    ...
    //    //
    //    // With the default configsModerator value below the application will use 'low' quality until the thumbnails are
    ...
    // some other values in configsModerator.js to be enabled. Also, the "profile" button will
    ...
    hiddenPremeetingButtons: ['settings'],
    ...
    // The callstats initialize configsModerator params as described in the API:
    ...
    /**
     ...
     The configsModerator file should be in JSON.
